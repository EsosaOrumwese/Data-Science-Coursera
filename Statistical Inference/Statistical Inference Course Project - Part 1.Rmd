...
From the plot, the theoretical mean, which is at `r I(theoretical.mean)` is shown by the red vertical line. By comparison, it is noticed that the sample mean (`r I(sample.mean)`) is similar to the theoretical mean (`r I(theoretical.mean)`)
...
```
It can be observed that the sample variance of `r I(sample.variance)` is equivalent to the theoretical variance of `r I(theoretical.variance)`.
